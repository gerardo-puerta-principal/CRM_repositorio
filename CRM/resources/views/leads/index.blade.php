<x-layouts.app title="Leads">
    <x-ui.card>
        <x-ui.page-header
            title="Leads"
            subtitle="Tabla principal con búsqueda rápida, lectura más clara y herramientas de asignación para operación diaria."
        >
            <x-slot:actions>
            ...
            <div class="surface" style="margin-bottom: 20px; padding: 20px;">
                <div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 16px; margin-bottom: 16px; flex-wrap: wrap;">
                    <div>
                        ...
                        <p style="margin: 0; max-width: 68ch; font-size: 14px;">
                            Toma los leads visibles del filtro actual que aún no tienen agente asignado y los distribuye entre los agentes seleccionados.
                        </p>
                    </div>
                    <x-ui.badge>Asignación asistida</x-ui.badge>
                </div>
                ...
                <form method="POST" action="{{ route('leads.round-robin') }}" style="display: grid; gap: 14px;">
                    ...
                    <div style="display: flex; flex-wrap: wrap; gap: 10px;">
                        ...
                        @empty
                            <div class="meta">No hay agentes activos disponibles para asignación.</div>
                        @endforelse
                    </div>
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between; gap: 12px; flex-wrap: wrap;">
                        <div class="meta">Selecciona dos o más agentes para repartir el flujo de trabajo visible.</div>
            ...
            <table>
                <thead>
                    <tr style="text-align: left; border-bottom: 1px solid var(--border); background: rgba(37, 99, 235, 0.04);">
                        ...
                        <th style="padding: 14px 16px;">Capturó</th>
                        <th style="padding: 14px 16px;">Acción rápida</th>
                        ...
                        <tr style="border-bottom: 1px solid var(--border);">
                            ...
                            <td style="padding: 16px;">
                                <div style="display: grid; gap: 4px;">
                                    ...
                                    <div class="meta">{{ $lead->email ?: 'Sin correo' }}</div>
                                </div>
                            </td>
                            <td style="padding: 16px;">
                        ...
                        <tr>
                            <td colspan="8" style="padding: 0;">
                                <x-ui.empty-state
                                    ...
                                    description="Prueba con otro estado, limpia la búsqueda o crea un lead manual para iniciar el flujo comercial."
                                />
                            </td>
                        </tr>
                    @endforelse
